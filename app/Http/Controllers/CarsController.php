...
class CarsController extends Controller
{
  ...
  /**
    ...
    public function store(Request $request)
    {
        ...
        $car->isava = 1;
       // $car->rent_start = $rent->rent_start;
        ...
        return redirect('/Car')->with('success', 'Voiture Ajoutée');
        
    }
    return redirect()->route('/Car')->with(['fail'=>'Erreur veuillez réessayer']);
}
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/Car')->with('success', 'Voiture Modifiée');
    }
    ...
    public function destroy($id)
    {
        ...
        $car->delete();
        return redirect('/Car')->with('success', 'Voiture Supprimée');
