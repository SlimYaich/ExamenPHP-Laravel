            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="mobile" class="col-md-4 col-form-label text-md-right">{{ __('Numéro de Téléphone') }}</label>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="isAgent" id="isAgent" value=0 checked>
                            <label class="form-check-label" for="user">
                              Je suis un Client
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="isAgent" id="isAgent" value=1>
